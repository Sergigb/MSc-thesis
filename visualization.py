...
use_lda_labels = True  # use the labels generated by the LDA instead of the neural network
...
if use_lda_labels:
    ...
    emb_filename = 'data/2d-embeddings-mylabels.npy'
    ids_filename = 'data/ids-embeddings-mylabels-.pkl'
...
if os.path.isfile(emb_filename):
    ...
    if use_lda_labels:
        ...
        X_embedded = TSNE(n_components=2, perplexity=40, early_exaggeration=24.0, verbose=1).fit_transform(X)
        ...
        model_path = 'exps/ttn-paper-parameters-mulabels/models/model-epoch-4.pth'
