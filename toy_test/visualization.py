...
n_topics = 2
batch_size = 128
model_path = '../models/toy_example13/models/model-epoch-12.pth'

emb_filename = '../data/2d-embeddings-toy-13-12.npy'
ids_filename = '../data/ids-embeddings-toy-13-12.pkl'
if mixture_model:
    alpha_filename = '../data/alpha-toy-13-12.npy'
    sigma_filename = '../data/sigma-toy-13-12.npy'
...
if use_lda_labels:
    ...
    if os.path.isfile(emb_filename):
        ...
        model = CNN(n_topics, n_kernels, out_dim=64, mixture_model=mixture_model, cnn='alexnet')
...
plt.scatter(rand_jitter(X[5:10, 0]), rand_jitter(X[5:10, 1]), c=sigma_values[5:10], s=64)
...
fig1, ax1 = plt.subplots()
plt.scatter(X[5:10, 0], X[5:10, 1], c=alpha_values[5:10], s=64)
